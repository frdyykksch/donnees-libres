 ...
 */
vector<long double> separateur_coordonnees(vector<string> colonne) {
    vector<string> t;
    ...
    vector<long double> colonne2 = conversionDouble(t);
    return colonne2;
}
...
int main() {
    ...
    vector<long double> position = separateur_coordonnees(position_str);
